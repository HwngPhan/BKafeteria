          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-6 text-white/90 text-sm mt-4">
              <div className="flex items-center gap-2">
                <Clock size={18} />
                <span>
                  {vendor.workingHourFrom?.substring(0, 5)} -{" "}
                  {vendor.workingHourTo?.substring(0, 5)}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <Info size={18} />
