...
public class MenuItemController {
  ...
  @PreAuthorize("hasAnyRole('MANAGER')")
   public ResponseEntity<ApiResponse<MenuItemDto>> register(@RequestBody @Valid CreateMenuItemRequest createMenuItemRequest,
                                                            @AuthenticationPrincipal CustomUserDetails userDetails){
    try{
      String managerId = userDetails.getId();
      MenuItemDto menuItemDto = menuItemDtoConverter.convert(menuItemService.createMenuItem(createMenuItemRequest,managerId));
  ...
  @PreAuthorize("hasAnyRole('MANAGER')")
  public ResponseEntity<ApiResponse<List<MenuItemDto>>> getMenuItemsByVendor(@AuthenticationPrincipal CustomUserDetails userDetails) {
    try{
      String managerId = userDetails.getId();
      List<MenuItemDto> menuItemDtos = menuItemDtoConverter.convertList(menuItemService.getMenuItemsByVendor(managerId));
  ...
  @PreAuthorize("hasAnyRole('MANAGER')")
  public ResponseEntity<ApiResponse<MenuItemDto>> updateMenuItem(@RequestBody @Valid CreateMenuItemRequest updateMenuItemRequest,
  ...
  @PreAuthorize("hasAnyRole('MANAGER')")
  public ResponseEntity<ApiResponse<Void>> deleteMenuItem(@AuthenticationPrincipal CustomUserDetails userDetails, String id){
    try{
